...
1. Effective Harnesses for Long-Running Agents. [[Blog]](https://www.anthropic.com/engineering/effective-harnesses-for-long-running-agents) `Blog 2025`
1. Building a C compiler with a team of parallel Claudes. [[Blog]](https://www.anthropic.com/engineering/building-c-compiler) `Blog 2026`
##### Plan Generation
...
This section summarizes the major evaluation domains for agentic harness engineering. For the complete benchmark index, see [Representative Benchmarks by Task Domain](#4-representative-benchmarks-by-task-domain).
